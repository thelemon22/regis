...
.else
			...
			MPY W4*W7, B, [W9]+=2,W5
            MAC W5*W6, B, [W9]+=2,W4; Word0 (unsigned) x Word3 (signed)
			SFTAC B, #16; Shift right by 15 bits to align for Q31 format
			MAC W5*W7, B, [W9]-=6,W5; Word1 (signed) x Word 3 (signed)
...
.else
			...
			MAC W4*W7, B, [W9]+=2,W4; Word0 (unsigned) x Word3 (signed)
			SFTAC B, #16; Shift right by 15 bits to align for Q31 format
			MAC W5*W7, B, [W9]+=2,W5; Word1 (signed) x Word 3 (signed)
...
.else
			...
			MAC W4*W7, A, [W9]+=2,W4; Word0 (unsigned) x Word3 (signed)
			SFTAC A, #16; Shift right by 15 bits to align for Q31 format
			MAC W5*W7, A, [W9]-=6,W5; Word1 (signed) x Word 3 (signed)
