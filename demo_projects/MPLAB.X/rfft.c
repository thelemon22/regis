...
//__attribute__ ((space(auto_psv), aligned (FFT_BLOCK_LENGTH*2)));/* array declared in Y-data space. */

int fftIn[FFT_BLOCK_LENGTH*2];
fractcomplex fftOut[FFT_BLOCK_LENGTH]; // __attribute__ ((aligned(FFT_BLOCK_LENGTH*2*2)));
